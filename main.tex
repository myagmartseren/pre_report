...
% \floatsetup[table]{style=plaintop, capbesideposition={top,right}}
...
\reader{магистр Ц.Манлайбаатар} % Шүүмжлэгчийн нэр, Дурын газарт бол \readname командыг хэрэглэнэ
\advisorA{доктор (Ph.D), В.Нямсүрэн} % Зөвлөгчийн нэр, Дурын газарт бол \advicenameA командыг хэрэглэнэ
...
\include{FrontBackMatter/Introduction} % Удиртгал хэсэг

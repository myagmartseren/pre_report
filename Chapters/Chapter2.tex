...
\begin{enumerate}
    ...
    \item Алис өгөгдлөө шифрлэж серверт байршуулна.
    \item Алис-ын өгөгдлийг Боб-той хуваацлахын тулд \emph{RE(pkB,skB,pkC,skC∗)} шифрлэж серверт байршуулна. Бобын хувийн заавал шаардахгүй үүсгэж болно.

...
\begin{lstlisting}[language=Python, caption={Энгийн API үүсгэж буй код}]
...
\begin{lstlisting}[language=C, caption={Method-ууд}]
...
\begin{lstlisting}[language=C, caption={Модуль нь init хийхэд зарлах классууд}]
